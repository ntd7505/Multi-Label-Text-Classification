...
👉 **Level 1 (Domain)** $\rightarrow$ **Level 2 (Sub-domain)** $\rightarrow$ **Level 3 (Fine-grained)**

## 🌟 Điểm nổi bật của dự án
* **Tiền xử lý chuyên biệt:** Sử dụng `underthesea` để tách từ tiếng Việt, kết hợp lọc stopwords nhằm bảo toàn ngữ nghĩa của các từ ghép đa âm tiết.
...
Chạy notebook: notebooks/preprocessing_data.ipynb
...
Chạy notebook: notebooks/train_w2v_clean.ipynb
...
Chạy notebook: notebooks/evaluation.ipynb
...
Chạy notebook: notebooks/predict.ipynb
